        ...
        const apply = (date, options = {}) => {
            if (options.utc) {
                ...
                if (options.month !== undefined)
                    date.setUTCMonth(options.month - 1);
                ...
                if (options.seconds !== undefined)
                    date.setSeconds(options.seconds);
                if (options.milliseconds !== undefined)
                    date.setMilliseconds(options.milliseconds);
            }
            return date;
        };
        /**
        ...
        const arithmetic = (date, sign, options = {}) => {
            if (options.utc) {
                if (options.years !== undefined)
                    date.setUTCFullYear(date.getUTCFullYear() + (sign * options.years));
                if (options.months !== undefined)
                    date.setUTCMonth(date.getUTCMonth() + (sign * options.months));
                if (options.days !== undefined)
                    date.setUTCDate(date.getUTCDate() + (sign * options.days));
                if (options.hours !== undefined)
                    date.setUTCHours(date.getUTCHours() + (sign * options.hours));
                if (options.minutes !== undefined)
                    date.setUTCMinutes(date.getUTCMinutes() + (sign * options.minutes));
                if (options.seconds !== undefined)
                    date.setUTCSeconds(date.getUTCSeconds() + (sign * options.seconds));
                if (options.milliseconds !== undefined)
                    date.setUTCMilliseconds(date.getUTCMilliseconds() + (sign * options.milliseconds));
            }
            else {
                if (options.years !== undefined)
                    date.setFullYear(date.getFullYear() + (sign * options.years));
                if (options.months !== undefined)
                    date.setMonth(date.getMonth() + (sign * options.months));
                if (options.days !== undefined)
                    date.setDate(date.getDate() + (sign * options.days));
                if (options.hours !== undefined)
                    date.setHours(date.getHours() + (sign * options.hours));
                if (options.minutes !== undefined)
                    date.setMinutes(date.getMinutes() + (sign * options.minutes));
                if (options.seconds !== undefined)
                    date.setSeconds(date.getSeconds() + (sign * options.seconds));
                if (options.milliseconds !== undefined)
                    date.setMilliseconds(date.getMilliseconds() + (sign * options.milliseconds));
            }
            return date;
        };
